...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct 17 00:27:06 2018
...
# Import the dataset and seperate the independent and dependent variable
...
# Fir KNN classifier to the train set
...
# Visualizing the results (On Train Set)
...
plot.title("KNN classifier (Train Set)")
plot.xlabel("Age")
...
plot.title("KNN classifier (Test Set)")
plot.xlabel("Age")
plot.ylabel("Estimated Salary")
plot.legend()
plot.show()